...
def correctness_build_request(
    *,
    ...
    request: dict[str, Any] = {
        ...
        "prebuilt_client": "/src/rocm-libraries/agent_run/260802-ductile-factorized-guidance-s10r4-exact-frame-binding-02/artifacts/prelabel-build/native/build/hipblaslt/tensilelite/client/tensilelite-client",
        "timeout_s": 7200,
    }
