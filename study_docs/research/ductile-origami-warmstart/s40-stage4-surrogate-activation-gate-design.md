...
不另建data-insufficiency blocker memo。Data insufficiency、forbidden cause或inconclusive都寫入本formal report並完成closeout；只有`S4_ACTIVATE` positive committed closeout可開始S41。
