...
| S14 | Stage 1 full-GA baseline-vs-guided real-GPU outcome（RESCOPE-STAGE1-OUTCOME-20260807；active,two-reviewer AGREE 2026-08-07;pins: P0-cap=512（user-authorized 2026-08-07,was 64）／5 seeds 4/5（user-authorized 2026-08-07,was 3/3）／G-F,S optional-reserved;native early-stop kept(n_gen=30 max);champion-primary,AUC secondary;5-seed 可平行(5 卡);pre-seal preflight required）| `approved` | `gated` | `DESIGN_APPROVED` | `not_evaluated` | `absent` | `reports/full-ga-baseline-vs-guided-outcome-report.md` |
